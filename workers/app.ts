...
IMPORTANT: Output ONLY with a valid JSON output, each sentece-prediction separate string in an array, no markdown formating. Example: ["1st sentence", "2nd phrase", "3rd sentence", "4th sentence", "the last sentence"]`;
